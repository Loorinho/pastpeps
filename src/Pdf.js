...
export default function Pdf() {
  ...
  const { course, semester, choice, year, yearzy } = useParams();
      ...
      <div className="mt-3 zind2">
        ...
        <center className="zind2">
          <Document
            ...
            file={`/${course}${year}${semester}${yearzy}${choice}.pdf`}
            ...
            {Array.from(new Array(numPages), (element, index) => (
              <div className="m-4 mt-2">
                <Page
                  ...
                  width="850"
                />
                <div className="bg-dark text-light d-flex justify-content-around pt-1">
                  <p>
                    Page {index + 1} of {numPages}
                  </p>
                  <p class="text-end">&copy; Copyright | PastPEPS</p>
                </div>
              </div>
            ))}
          </Document>
